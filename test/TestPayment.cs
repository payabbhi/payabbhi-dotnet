...
namespace UnitTesting.Payabbhi.Tests {
    public class TestPayment {
        ...
        public void TestCreateTransfersAgainstPayment () {
            ...
            Dictionary<string, object> transferItem1 = new Dictionary<string, object> () { { "amount", 20 }, { "currency", "INR" }, { "description", "Tranfer 1" }, { "beneficiary_id", "recp_Y2ojRlJVqRMhB0Ay" }
            };
            Dictionary<string, object> transferItem2 = new Dictionary<string, object> () { { "amount", 30 }, { "currency", "INR" }, { "description", "Tranfer 2" }, { "beneficiary_id", "recp_Y2ojRlJVqRMhB0Ay" }
            };
            Dictionary<string, object> transferItem3 = new Dictionary<string, object> () { { "amount", 50 }, { "currency", "INR" }, { "description", "Tranfer 3" }, { "beneficiary_id", "recp_Y2ojRlJVqRMhB0Ay" }
            };
            Dictionary<string, object>[] transferArr = { transferItem1, transferItem2, transferItem3 };
            var transfers = payment.Transfer (new Dictionary<string, object> () { { "transfers", transferArr }
            });
            expectedJsonString = Helper.GetJsonString (filepath2);
