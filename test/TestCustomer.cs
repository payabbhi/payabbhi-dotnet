...
namespace UnitTesting.Payabbhi.Tests {
    public class TestCustomer {
        ...
        public void TestUpdateCustomer () {
            ...
            customer = customer.Update (new Dictionary<string, object> () { { "email", "a@b.com" }, { "contact_no", "8433894351" },
            });
        ...
        public void TestEmptyCustomerUpdate () {
            ...
            Client client = new Client (ACCESSID, SECRETKEY, Helper.GetMockRequestFactory (filepath, customerURL));
            var ex = Assert.Throws<InvalidRequestError> (() => client.Customer.Update (new Dictionary<string, object> () { { "email", "a@b.com" }, { "contact_no", "8433894351" }
            }));
